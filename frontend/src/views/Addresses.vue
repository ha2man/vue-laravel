<template>
  <div>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
      <h2 class="text-lg font-medium mr-auto">Your Addresses</h2>
    ...
    <!-- BEGIN: Address Data -->
    <div>
      <h1 v-if="addresses.length <= 0" class="text-center block text-lg mt-5">
      ...
      <div class="grid grid-cols-12 gap-6 mt-5">
        <div
          ...
          :key="'a-' + index"
          class="col-span-12 md:col-span-6 lg:col-span-3 h-full shadow-xl"
        >
          <div
            class="intro-y box"
          ...
          >
            ...
            >
              ...
              <div class="dropdown ml-auto sm:ml-0">
                <a class="dropdown-toggle text-white-700 dark:text-gray-300">
                ...
                <div class="dropdown-box w-40 shadow-lg">
                  <div class="dropdown-box__content box dark:bg-dark-1 p-2">
                    ...
                    >
                      <CheckCircleIcon class="w-6 h-6 mr-2"></CheckCircleIcon>
                      Set As Primary
                    </a>
                    <a
                    ...
                    >
                      <Trash2Icon class="w-6 h-6 mr-2"></Trash2Icon> Remove
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="p-5 preview">
              <p class="mt-3 flex justify-between">
                Street Name: <b class="w-2/3">{{ a.street_name }}</b>
              </p>
              <p class="mt-3 flex justify-between">
                Street: <b class="w-2/3">{{ a.street }}</b>
              </p>
              <p class="mt-3 flex justify-between">
